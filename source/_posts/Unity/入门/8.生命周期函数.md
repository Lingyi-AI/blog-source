...
![图](images/Unity/入门/生命周期函数.png)

### 知识点四 生命周期函数 支持继承多态 （可以继承重写虚函数）

---
### 总结
这些生命周期函数 如果你不打算在其中写逻辑 那就不要在这写出生命周期函数


![图](images/Unity/入门/生命周期函数习题.png)