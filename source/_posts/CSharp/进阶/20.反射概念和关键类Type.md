---
title: 20.反射概念和关键类Type
date: 2025-12-10 22:12
categories:
  - 编程语言
  - CSharp
  - 进阶
...
``` CSharp
//1.获取所有构造函数
ConstructorInfo[] ctors = t.GetConstructors();	//（有s得到所以，没有s得到一个）
...
//1.先加载一个指定程序集
Assembly assembly = Assembly.LoadFrom(@"C:\Users\MECHREVO\Desktop\CSharp进阶教学\Lesson18 练习题\bin\Debug......");
...
//2.再加载程序集中的一个类对象 之后才能使用反射  //（更多是对Type的使用）
...
![图](images/CSharp/进阶/反射概念和关键类Type练习题.png)