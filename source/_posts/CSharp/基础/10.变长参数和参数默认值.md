...
3.函数名，帕斯卡命名法
4.参数可以是0~n个  前面可以加  ref  和  out  用来传递想要在函数内部改变内容的变量
...
``` CSharp
static void Speak2(string test, string name = "唐老狮", string str = "我没什么话可说")
{
...
![图](images/CSharp/基础/变长参数和参数默认值练习题.png)